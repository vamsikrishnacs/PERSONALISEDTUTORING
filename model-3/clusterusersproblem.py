...
for line8 in csv8:
	testdict[line8[0]].append([line8[1],line8[2]])
...
for i in testdict.keys():
	...
	if(t==8	):
		...
		print testdict[i][0][1]+'\t'+testdict[i][1][1]+'\t'+testdict[i][2]+'\t'+testdict[i][3]+'\t'+testdict[i][4]+'\t'+testdict[i][5]+'\t'+testdict[i][6]+'\t'+testdict[i][7][0]
